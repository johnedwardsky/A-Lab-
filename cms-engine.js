...
(function () {
    ...
    const CMS = {
        ...
        _renderAnalytics(container, data) {
            ...
            // Geographic projection: [lon,lat] → SVG coords (viewBox 960x400)
            const _gp = (pts) => pts.map(([n,t],i) =>
                (i?'L':'M')+((n+180)*2.667|0)+','+((80-t)*2.857|0)).join(' ')+'Z';
            const _s = 'fill="rgba(0,229,255,0.03)" stroke="rgba(0,229,255,0.15)" stroke-width="0.8"';

            const continentPaths = [
              // North America
              _gp([[-168,65],[-160,55],[-153,57],[-148,61],[-140,60],[-136,58],[-130,54],[-125,49],[-124,44],[-122,37],[-117,33],[-115,30],[-110,23],[-105,20],[-100,17],[-96,16],[-92,14],[-87,14],[-84,11],[-80,8],[-79,9],[-83,10],[-86,15],[-88,18],[-87,21],[-90,21],[-97,20],[-97,26],[-94,29],[-90,30],[-85,30],[-83,28],[-81,25],[-80,27],[-80,32],[-77,35],[-75,39],[-74,41],[-71,42],[-67,44],[-60,47],[-53,47],[-56,52],[-60,55],[-65,60],[-64,63],[-74,64],[-79,62],[-86,57],[-95,63],[-110,68],[-125,70],[-140,70],[-155,71],[-165,69]]),
              // Greenland
              _gp([[-55,60],[-46,60],[-42,64],[-35,66],[-25,68],[-20,72],[-22,76],[-30,77],[-42,78],[-52,76],[-55,74],[-53,70],[-50,66]]),
              // South America
              _gp([[-80,8],[-77,8],[-73,11],[-72,12],[-68,11],[-63,10],[-60,7],[-55,5],[-51,2],[-48,-1],[-44,-3],[-41,-3],[-38,-5],[-35,-6],[-35,-10],[-37,-12],[-39,-15],[-40,-22],[-43,-23],[-47,-26],[-49,-28],[-52,-33],[-56,-35],[-65,-41],[-67,-46],[-68,-52],[-68,-54],[-71,-53],[-73,-46],[-72,-42],[-71,-37],[-71,-30],[-70,-24],[-70,-18],[-75,-15],[-77,-12],[-80,-7],[-80,-2],[-78,2],[-77,6]]),
              // Europe (Iberia → Scandinavia → Black Sea → Mediterranean)
              _gp([[-10,36],[-9,38],[-9,43],[-4,43],[1,44],[3,43],[5,44],[1,47],[-2,49],[-5,48],[-6,52],[-5,54],[-3,56],[-5,58],[-3,59],[2,57],[5,54],[8,54],[10,55],[12,57],[8,58],[5,62],[8,63],[12,64],[15,65],[18,69],[20,70],[25,71],[30,70],[28,65],[30,60],[24,57],[22,55],[24,54],[29,46],[30,43],[29,41],[26,40],[26,38],[24,35],[26,35],[28,41],[29,44],[24,48],[21,46],[16,40],[16,38],[13,38],[15,41],[14,43],[12,46],[9,41],[7,44],[5,44],[3,43],[0,43],[-2,40],[-5,37],[-6,36]]),
              // Africa
              _gp([[-6,35],[-5,36],[0,36],[3,37],[8,37],[10,33],[15,32],[20,33],[25,32],[30,31],[33,30],[34,27],[36,20],[38,18],[43,12],[44,12],[49,10],[51,12],[49,8],[45,2],[42,0],[40,-3],[40,-8],[40,-11],[37,-17],[35,-24],[32,-28],[28,-33],[26,-34],[19,-34],[18,-29],[15,-23],[12,-17],[13,-10],[12,-5],[9,-2],[9,1],[10,4],[3,5],[0,6],[-5,5],[-10,5],[-13,8],[-15,10],[-16,13],[-17,15],[-17,21],[-13,28],[-8,34]]),
              // Asia (Urals → Middle East → India → SE Asia → China → Russia E)
              _gp([[30,70],[35,68],[40,65],[50,65],[60,68],[70,70],[80,72],[90,73],[100,72],[110,70],[120,68],[125,65],[130,63],[135,60],[140,55],[142,53],[140,50],[142,47],[145,45],[140,40],[135,35],[128,35],[121,31],[117,25],[110,22],[108,16],[107,11],[105,10],[103,2],[101,3],[99,7],[98,16],[97,17],[93,20],[89,22],[85,22],[80,16],[76,8],[74,8],[73,15],[70,20],[67,25],[62,25],[60,24],[57,24],[55,26],[51,24],[48,29],[44,30],[40,30],[36,36],[34,32],[33,30],[32,31],[35,35],[36,37],[35,40],[30,43],[29,44],[30,60],[30,70]]),
              // Japan
              _gp([[130,31],[131,33],[134,35],[136,36],[137,38],[140,40],[141,42],[141,44],[140,45],[139,43],[137,36],[135,34],[132,33]]),
              // Australia
              _gp([[115,-35],[117,-34],[121,-34],[126,-33],[129,-32],[131,-34],[134,-33],[136,-35],[137,-36],[140,-38],[147,-39],[149,-38],[151,-34],[153,-28],[150,-23],[148,-20],[146,-19],[144,-15],[142,-11],[136,-12],[132,-12],[129,-15],[124,-15],[121,-18],[116,-20],[114,-22],[114,-26],[115,-32]]),
              // New Zealand
              _gp([[167,-47],[168,-45],[173,-42],[178,-38],[178,-36],[176,-37],[172,-41],[168,-44]]),
              // British Isles
              _gp([[-6,50],[-5,52],[-4,54],[-3,55],[-5,57],[-6,58],[-5,58],[-3,57],[-2,56],[0,53],[2,52],[1,51],[-1,51],[-3,50],[-5,50]]),
              // Indonesia (simplified)
              _gp([[95,6],[98,4],[104,-6],[106,-7],[110,-7],[112,-8],[114,-8],[117,-9],[120,-10],[119,-8],[116,-7],[112,-7],[108,-6],[106,-5],[105,0],[100,1],[97,4]]),
            ].map(d => `<path d="${d}" ${_s}/>`).join('');
            ...
            const labelData = [
              ...
              [54,24,'UAE'],[45,25,'Saudi\nArabia'],[30,27,'Egypt'],[8,10,'Nigeria'],
              ...
              [20,65,'Scandinavia'],[100,47,'Mongolia'],[69,29,'Pakistan'],[90,24,'Bangladesh'],
              [-45,72,'Greenland'],[19,52,'Poland'],[25,46,'Romania']
            ];
            const countryLabels = labelData.map(([ln,lt,nm]) => {
              const lx = ((ln+180)*2.667)|0, ly = ((80-lt)*2.857)|0;
