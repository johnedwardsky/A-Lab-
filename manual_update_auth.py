...
# We still need CSRF and Session ID. I'll try to use the ones from the cookies if they exist.
# Usually f.sid is the session id. In batch execute logs it often matches SID or some derivative.
# However, SNlM0e is a CSRF token.

data = {
    "cookies": cookies,
    "csrf_token": "AJuGmaevulFR_KzThUfSrzDBeLRd:1772110060471",
    "session_id": "7774170313977506978"
}

with open("/Users/johnsky/.notebooklm-mcp/auth.json", "w") as f:
    json.dump(data, f, indent=2)

print("Updated auth.json with new cookies.")
